...
const Navbar = () => {
  ...
  const handalLogOut = () => {
    ...
    setUser({ username: "default", password: "123", role: "USER", id: 3 });
            ...
            <div className="flex items-center gap-4">
              {username === null || username === "default" ? (
                <div className="sm:flex sm:gap-4">
                  ...
                  <Link
                    className="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 transition hover:text-teal-600/75 md:block dark:bg-gray-800 dark:text-white dark:hover:text-teal-600"
                    to="/signup"
                  >
                    Register
                  </Link>
                ...
                <>
                  ...
                  >
                    {user?.id}
                    {user?.role} Hello, {username?.toUpperCase()} Cart{" "}
                    {cartNumber}
                  </Link>
                  <button
